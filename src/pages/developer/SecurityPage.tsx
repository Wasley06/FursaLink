...
type AuditLog = { id: string; actorId: string; action: string; createdAt?: any };
    ...
    <div className="space-y-6">
      <div className="premium-card">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-navy">Security Logs</h1>
            <p className="text-sm text-muted font-medium">Read-only audit visibility.</p>
          </div>
        </div>
      </div>
      ...
      <div className="premium-card">
        {loading ? (
          ...
          <div className="text-sm text-muted italic">No logs.</div>
        ) : (
