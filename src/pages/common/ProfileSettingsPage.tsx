        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="relative">
              <Camera className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted" />
              <input className="input-field pl-11" value={form.photoUrl} onChange={(e) => setForm((p) => ({ ...p, photoUrl: e.target.value }))} placeholder="https://…" />
            </div>
          </div>
        </div>
